...
/// Player commits choice by submitting hash(choice || secret)
...
/// Reveal phase: player shows choice and secret, verify against commit
...
/// Decide winner and transfer coins
public fun settle(
    game: &mut Game,
